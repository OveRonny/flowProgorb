<template>
  <div class="min-h-screen bg-gray-100 p-6 dark:bg-gray-900">
    <div class="mx-auto max-w-7xl space-y-6">
      <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Development</h1>
        <p class="mt-1 text-gray-600 dark:text-gray-400">Manage features, modules, and tasks across all projects</p>
      </div>
      ...
      <p v-if="authStore.loading" class="text-gray-600 dark:text-gray-400">Loading projects...</p>
      ...
      <div v-else class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div class="space-y-3">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ project.description || 'No description' }}</p>
